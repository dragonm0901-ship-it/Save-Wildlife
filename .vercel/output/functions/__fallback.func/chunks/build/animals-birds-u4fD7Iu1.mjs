...
import { _ as __nuxt_component_0$2 } from './WildButton-9r5Jthnm.mjs';
import { ref, withAsyncContext, computed, watch, nextTick, mergeProps, unref, withCtx, createVNode, toDisplayString, createTextVNode, useSSRContext } from 'vue';
...
function useGsapAnimations() {
  ...
  function fadeUp(elements, options = {}) {
    ...
    if (!elements || typeof elements === "string" && !(void 0).querySelector(elements)) return;
    return gsapWithCSS.from(elements, {
      ...defaults,
      scrollTrigger: {
  ...
  function parallax(element, options = {}) {
    ...
    return gsapWithCSS.to(element, {
      y: () => -(ScrollTrigger.maxScroll(void 0) * speed),
      ease: "none",
      scrollTrigger: {
  ...
  function clipReveal(element, options = {}) {
    return gsapWithCSS.from(element, {
      clipPath: options.direction === "horizontal" ? "inset(0 100% 0 0)" : "inset(100% 0 0 0)",
      duration: 1.2,
      ease: "power4.inOut",
      ...options,
      scrollTrigger: {
  ...
  function staggerChildren(parent, childSelector, options = {}) {
    const children = typeof parent === "string" ? (void 0).querySelectorAll(`${parent} ${childSelector}`) : parent?.querySelectorAll(childSelector);
    if (!children || children.length === 0) return;
    return gsapWithCSS.from(children, {
      y: 40,
      opacity: 0,
      duration: 0.8,
      stagger: 0.1,
  ...
  function splitTextReveal(element, options = {}) {
    ...
    return gsapWithCSS.from(element.children, {
      y: "110%",
      rotateX: -80,
      opacity: 0,
      duration: 0.9,
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const { data: animals, pending, error, refresh } = ([__temp, __restore] = withAsyncContext(() => useFetch(
      "/api/animals",
      {
        lazy: true,
        server: false
    ...
    watch(activeFilter, async () => {
      await nextTick();
      const { gsap: gsap2 } = useGsapAnimations();
      gsap2.from(".animal-card", {
        y: 40,
        opacity: 0,
        duration: 0.6,
        stagger: 0.05,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UiWildButton = __nuxt_component_0$2;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "animals-page" }, _attrs))} data-v-97a24698><section class="page-hero" data-v-97a24698>`);
      ...
      _push(`<div class="page-hero__overlay" data-v-97a24698></div><div class="container page-hero__content" data-v-97a24698><h1 class="page-hero__title" data-v-97a24698>Nepal&#39;s Living Heritage</h1><div class="page-hero__meta" data-v-97a24698><strong class="page-hero__label" data-v-97a24698>Biodiversity</strong><p data-v-97a24698>Explore the diverse fauna and flora across Nepal&#39;s unique ecological zones, from the Terai to the Himalayas.</p></div></div></section>`);
      _push(ssrRenderComponent(_component_UiSectionLabel, { items: ["ANIMALS", "BIRDS", "FLORA", "CONSERVATION"] }, null, _parent));
      _push(`<section class="section section--bone" id="animals-grid-section" data-v-97a24698><div class="container" data-v-97a24698><div class="filter-tabs" data-v-97a24698><!--[-->`);
      ssrRenderList(filterTabs, (tab) => {
        _push(`<button class="${ssrRenderClass([{ "filter-tab--active": activeFilter.value === tab.value }, "filter-tab"])}" data-v-97a24698>${ssrInterpolate(tab.label)}</button>`);
      });
      _push(`<!--]--></div>`);
      if (unref(pending)) {
        _push(`<div class="loading-state" data-v-97a24698><p data-v-97a24698>Scouting for wildlife...</p></div>`);
      } else if (filteredAnimals.value && filteredAnimals.value.length) {
        _push(`<div class="animals-grid" data-v-97a24698><!--[-->`);
        ssrRenderList(filteredAnimals.value, (animal) => {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="animal-card__image" data-v-97a24698${_scopeId}>`);
                ...
                _push2(`<div class="animal-card__overlay" data-v-97a24698${_scopeId}><span class="animal-card__habitat label" data-v-97a24698${_scopeId}>${ssrInterpolate(animal.habitat)}</span></div></div><div class="animal-card__content" data-v-97a24698${_scopeId}><h3 class="animal-card__name" data-v-97a24698${_scopeId}>${ssrInterpolate(animal.name)}</h3><p class="animal-card__scientific" data-v-97a24698${_scopeId}>${ssrInterpolate(animal.scientific)}</p></div>`);
              } else {
                return [
                  createVNode("div", { class: "animal-card__image" }, [
                    ...
                    createVNode("div", { class: "animal-card__overlay" }, [
                      createVNode("span", { class: "animal-card__habitat label" }, toDisplayString(animal.habitat), 1)
                    ])
                  ]),
                  createVNode("div", { class: "animal-card__content" }, [
                    createVNode("h3", { class: "animal-card__name" }, toDisplayString(animal.name), 1),
                    createVNode("p", { class: "animal-card__scientific" }, toDisplayString(animal.scientific), 1)
                  ])
                ];
              }
            }),
        ...
        _push(`<div class="error-state" data-v-97a24698><p data-v-97a24698>We&#39;re having trouble locating the wildlife. Please try again later.</p>`);
        ...
        _push(`<div class="empty-state" data-v-97a24698><div class="empty-state__icon" data-v-97a24698><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-v-97a24698><path d="M10 10l5 5m0-5l-5 5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" data-v-97a24698></path></svg></div><p data-v-97a24698>No species found matching the current filter.</p>`);
        _push(ssrRenderComponent(_component_UiWildButton, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/animals-birds.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const animalsBirds = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-97a24698"]]);

export { animalsBirds as default };
//# sourceMappingURL=animals-birds-u4fD7Iu1.mjs.map
