import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, getCurrentInstance, toRef, isRef, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, computed, toValue, onServerPrefetch, reactive, defineAsyncComponent, unref, shallowReactive, ref, Suspense, Fragment, createApp, onErrorCaptured, createVNode, resolveDynamicComponent, effectScope, nextTick, mergeProps, withCtx, getCurrentScope, isReadonly, toRaw, useSSRContext, isShallow, isReactive } from 'vue';
import { n as parseURL, o as encodePath, q as decodePath, s as hasProtocol, t as isScriptProtocol, l as joinURL, w as withQuery, v as sanitizeStatusCode, x as getContext, $ as $fetch, y as baseURL, z as hash, A as defu, c as createError$1, B as executeAsync, C as getHeader, D as setCookie } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "auth-login",
    path: "/auth/login",
    component: () => import('./login-CdrqK-5l.mjs')
  },
  {
    name: "auth-signup",
    path: "/auth/signup",
    component: () => import('./signup-d1btL_cE.mjs')
  },
  {
    name: "animals-slug",
    path: "/animals/:slug()",
    component: () => import('./_slug_-7xpTUiXb.mjs')
  },
  {
    name: "blogs-slug",
    path: "/blogs/:slug()",
    component: () => import('./_slug_-gM8Awd9N.mjs')
  },
  {
    name: "events-slug",
    path: "/events/:slug()",
    component: () => import('./_slug_-Tx2sSx6D.mjs')
  },
  {
    name: "services-slug",
    path: "/services/:slug()",
    component: () => import('./_slug_-rK2S9FWh.mjs')
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./about-BRchnbM4.mjs')
  },
  {
    name: "animals-birds",
    path: "/animals-birds",
    component: () => import('./animals-birds-u4fD7Iu1.mjs')
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import('./checkout--jg7RL7V.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-DR5P9gTd.mjs')
  },
  {
    name: "donation",
    path: "/donation",
    component: () => import('./donation-DcjlwHrk.mjs')
  },
  {
    name: "events",
    path: "/events",
    component: () => import('./index-CAOoliBM.mjs')
  },
  {
    name: "faq",
    path: "/faq",
    component: () => import('./faq-I9f7gkCp.mjs')
  },
  {
    name: "inquiry",
    path: "/inquiry",
    component: () => import('./inquiry-u9Sp-_Gt.mjs')
  },
  {
    name: "news",
    path: "/news",
    component: () => import('./news-Bw56JrwU.mjs')
  },
  {
    name: "privacy-policy",
    path: "/privacy-policy",
    component: () => import('./privacy-policy-CXNgbfbH.mjs')
  },
  {
    name: "services",
    path: "/services",
    component: () => import('./index-DZjdm33n.mjs')
  },
  {
    name: "terms-conditions",
    path: "/terms-conditions",
    component: () => import('./terms-conditions-nEfuMeD3.mjs')
  },
  {
    name: "tickets",
    path: "/tickets",
    component: () => import('./tickets-AeN0W1y1.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BDh97VW9.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BwAyU69d.mjs').then((m) => m.default || m))
};
  ...
  setup(__props) {
    useHead({
      titleTemplate: (titleChunk) => {
        return titleChunk ? `${titleChunk} — Save Wildlife` : "Save Wildlife — Nepalese Sanctuary";
      }
    });
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CGimL_E5.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Cc0Xz0Or.mjs'));
...
export { useRouter as a, useNuxtApp as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry_default as default, encodeRoutePath as e, useRoute as f, useFetch as g, useRequestEvent as h, useSupabaseUser as i, navigateTo as n, resolveRouteObject as r, useHead as u };
