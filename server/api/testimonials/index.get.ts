const fallbackTestimonials = [
  ...
  {
    id: 9, name: 'Anjali Sharma', role: 'Local Guide',
  ...
  {
    id: 10, name: 'Marcus Thoenen', role: 'Backpacker',
  ...
  {
    id: 11, name: 'Elena Petrova', role: 'Wildlife Artist',
  ...
  {
    id: 12, name: 'Kenji Sato', role: 'Retired Teacher',
  ...
  {
    id: 13, name: 'Clara Oswald', role: 'Discovery Channel Producer',
  ...
  {
    id: 14, name: 'Liam Neeson (Fan)', role: 'Adventure Seeker',
